...
## [0.18.2](https://github.com/tx3-lang/tx3/compare/tx3c-v0.18.1...tx3c-v0.18.2) - 2026-05-21

### Added

- *(tx3c)* add json helper to the codegen renderer ([#325](https://github.com/tx3-lang/tx3/pull/325))
- *(tx3c)* add decode verb and structured diagnose output ([#324](https://github.com/tx3-lang/tx3/pull/324))
- *(tx3c)* introduce codegen command ([#306](https://github.com/tx3-lang/tx3/pull/306))
...
- extract tx3-tir into its own repository ([#321](https://github.com/tx3-lang/tx3/pull/321))
- move TII and TRP specs to standalone repos ([#320](https://github.com/tx3-lang/tx3/pull/320))
